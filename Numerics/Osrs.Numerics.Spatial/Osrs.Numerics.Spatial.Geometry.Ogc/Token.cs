...
namespace Osrs.Numerics.Spatial.Geometry
{
    ...
    /// </summary>
    internal abstract class StringToken : Token
    {
        /// <summary>Default constructor.</summary>
    ...
    /// characters.
    /// </summary>
    internal class WordToken : StringToken
    {
    ...
    /// </summary>
    internal class QuoteToken : StringToken
    {
        /// <summary>Constructor with the specified value.</summary>
    ...
    /// comments.
    /// </summary>
    internal class CommentToken : StringToken
    {
        /// <summary>Constructor with the specified value.</summary>
    ...
    /// </summary>
    internal class WhitespaceToken : StringToken
    {
        /// <summary>Constructor with the specified value.</summary>
