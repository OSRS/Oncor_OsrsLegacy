...
{
    public sealed class PolygonSet2<T> : ISimpleGeometry<Polygon2<T>, T>, IGeometry2<T>, IMultiPartNestedPointCollection2<T>, IEquatable<PolygonSet2<T>>, IComparable<PolygonSet2<T>>, IEnumerable<Polygon2<T>>
        where T : IEquatable<T>, IComparable<T>
    {
        ...
        internal PolygonSet2(Polygon2<T>[] polygons)
        {
            if (polygons == null)
        ...
        public override bool Equals(object obj)
        {
            if (obj == null)
                return false;
            if (obj is PolygonSet2<T>)
                return this.Equals(obj as PolygonSet2<T>);
            return false;
        }
        ...
        {
            return this.CompareTo(obj as PolygonSet2<T>);
        }

        public int CompareTo(IGeometry other)
        {
            return this.CompareTo(other as PolygonSet2<T>);
        }

        public bool Equals(IGeometry other)
        {
            return this.Equals(other as PolygonSet2<T>);
        }
        ...
        public static implicit operator PolygonBag2<T>(PolygonSet2<T> item)
        {
            if (item == null)
                return null;
            return new PolygonBag2<T>(item.Polygons);
        }

        public static explicit operator PointBag2<T>(PolygonSet2<T> item)
        {
            if (item == null)
                return null;
