...
{
    //multiple simple polygons -- only outer rings, any overlaps possible
    public sealed class RingBag2<T> : ISimpleGeometry<Ring2<T>,T>, IMultiPartPointCollection2<T>, IEquatable<RingBag2<T>>, IComparable<RingBag2<T>>, IEnumerable<Ring2<T>>
        where T : IEquatable<T>, IComparable<T>
    {
        ...
        internal RingBag2(Ring2<T>[] chains)
        {
            if (chains == null)
        ...
        {
            return this.CompareTo(obj as RingBag2<T>);
        }

        public int CompareTo(IGeometry other)
        {
            return this.CompareTo(other as RingBag2<T>);
        }

        public bool Equals(IGeometry other)
        {
            return this.Equals(other as RingBag2<T>);
        }
