...
{
    //multi-polyline
    public sealed class PolylineSet2<T> : ISimpleGeometry<Polyline2<T>, T>, IMultiPartPointCollection2<T>, IEquatable<PolylineSet2<T>>, IComparable<PolylineSet2<T>>, IEnumerable<Polyline2<T>>
        where T : IEquatable<T>, IComparable<T>
    {
        ...
        internal PolylineSet2(Polyline2<T>[] chains)
        {
            if (chains == null)
        ...
        public PolylineSet2(PolylineSet2<T> cloned)
        {
            if (cloned == null)
                throw new ArgumentNullException();
        ...
        public int CompareTo(PolylineSet2<T> other)
        {
            if (other == null)
                return 1;
        ...
        public bool Equals(PolylineSet2<T> other)
        {
            if (other == null)
                return false;
            if (object.ReferenceEquals(this, other))
        ...
        {
            if (obj is PolylineSet2<T>)
                return this.Equals(obj as PolylineSet2<T>);
        ...
        {
            return this.CompareTo(obj as PolylineSet2<T>);
        }

        public int CompareTo(IGeometry other)
        {
            return this.CompareTo(other as PolylineSet2<T>);
        }

        public bool Equals(IGeometry other)
        {
            return this.Equals(other as PolylineSet2<T>);
        }
        ...
        public static implicit operator PolylineBag2<T>(PolylineSet2<T> item)
        {
            if (item == null)
                return null;
            return new PolylineBag2<T>(item.Lines);
        }
    }
}
