...
namespace Osrs.Text
{
    ...
    public struct StringSegment : IEquatable<StringSegment>, IEquatable<string>
    {
        ...
        public StringSegment(string buffer, int offset, int length)
        {
            ...
            {
                throw new ArgumentException("Offset and length are out of bounds for the string or length is greater than the number of characters from index to the end of the string.");
            }
