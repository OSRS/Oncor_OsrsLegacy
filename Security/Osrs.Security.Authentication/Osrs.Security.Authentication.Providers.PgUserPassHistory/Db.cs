...
namespace Osrs.Security.Authentication.Providers
{
    internal static class Db
    {
        ...
        internal const string Select = "SELECT \"Id\", \"UserName\", \"HistoryData\" FROM osrs.\"SecurityUserPassHistory\" WHERE \"Id\"=:id";
        internal const string Update = "SELECT osrs.\"updatesecurityuserpasshistory\"(:id, :uname, :payload)";
        internal const string Delete = "DELETE FROM osrs.\"SecurityUserPassHistory\" WHERE \"Id\"=:id";
