...
{
    public sealed class FieldTeamMemberRole : INamedEntity<CompoundIdentity>, IDescribable, IEquatable<FieldTeamMemberRole>
    {
        ...
        {
            return this.Equals(other as FieldTeamMemberRole);
        }

        public bool Equals(FieldTeamMemberRole other)
        {
            if (other != null)
