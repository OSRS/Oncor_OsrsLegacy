...
{
    public sealed class PgSiteProviderFactory : SiteProviderFactoryBase
    {
        private readonly Type myType = typeof(PgSiteProviderFactory);
        private bool initialized = false;
        private LogProviderBase logger;

        protected override SiteAliasProviderBase GetSiteAliasProvider(UserSecurityContext context)
        {
            return new PgSiteAliasProvider(context);
        }

        protected override SiteAliasSchemeProviderBase GetSiteAliasSchemeProvider(UserSecurityContext context)
        {
            return new PgSiteAliasSchemeProvider(context);
        }

        protected override SiteProviderBase GetSiteProvider(UserSecurityContext context)
        {
            return new PgSiteProvider(context);
        }
        ...
        public PgSiteProviderFactory()
        {
            instance = this;
        }

        private static PgSiteProviderFactory instance;
        public static PgSiteProviderFactory Instance
        {
            get { return instance; }
        }
    }
