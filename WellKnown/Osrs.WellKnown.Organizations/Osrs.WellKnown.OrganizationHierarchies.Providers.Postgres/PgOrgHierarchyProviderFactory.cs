...
{
    public sealed class PgOrgHierarchyProviderFactory : OrganizationHierarchyProviderFactoryBase
    {
        private readonly Type myType = typeof(PgOrgHierarchyProviderFactory);
        private bool initialized = false;
        private LogProviderBase logger;

        protected override OrganizationHierarchyProviderBase GetProvider(UserSecurityContext context)
        {
            if (this.initialized)
            {
                return new PgOrgHierarchyProvider(context);
            }
            return null;
        }
        ...
        public PgOrgHierarchyProviderFactory()
        {
            instance = this;
        }

        private static PgOrgHierarchyProviderFactory instance;
        public static PgOrgHierarchyProviderFactory Instance
        {
            get { return instance; }
        }
    }
